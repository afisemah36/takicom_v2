...
<form method="POST" action="<?= url('/devis') ?>" id="formDevis">
    <?= csrf_field() ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="numero_devis">N° Devis <span class="required">*</span></label>
                                <input type="text" id="numero_devis" name="numero_devis" class="form-control" value="<?= e($numero_devis) ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" id="date_devis" name="date_devis" class="form-control" value="<?= e($date_devis) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" id="date_validite" name="date_validite" class="form-control" value="<?= e($date_validite) ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="conditions" name="conditions" class="form-control" rows="2"></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info mt-2" id="alertLignes">
                <i class="fas fa-info-circle"></i> Cliquez sur "Ajouter une ligne" pour commencer à créer votre devis
            </div>
        </div>
    </div>
</form>
...
<script>
    ...
    function ajouterLigne() {
        document.getElementById('alertLignes').style.display = 'none';
        ...
        tr.innerHTML = `
            <td>
                ...
                <input type="text" class="form-control form-control-sm designation" placeholder="Ou saisir une désignation personnalisée">
                <input type="hidden" class="id-article">
            </td>
            <td>
                <input type="number" class="form-control form-control-sm quantite" value="1" min="0" step="0.001" onchange="calculerLigne(${ligneIndex})">
            </td>
            <td>
                <input type="number" class="form-control form-control-sm prix-unitaire" value="0" min="0" step="0.001" onchange="calculerLigne(${ligneIndex})">
            </td>
            <td>
                <input type="number" class="form-control form-control-sm taux-tva" value="19" min="0" max="100" step="0.01" onchange="calculerLigne(${ligneIndex})">
            </td>
            <td>
                <input type="number" class="form-control form-control-sm taux-remise" value="0" min="0" max="100" step="0.01" onchange="calculerLigne(${ligneIndex})">
            </td>
            <td class="text-right">
    ...
    function supprimerLigne(index) {
        if (confirm('Supprimer cette ligne ?')) {
            ...
            if (ligne) {
                ...
                if (document.querySelectorAll('#lignesDevis tr').length === 0) {
