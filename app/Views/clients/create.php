    ...
    <div class="card-body">
        <form method="POST" action="<?= url('/clients') ?>" class="form-horizontal">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="code_client"
                                class="form-control"
                                value="<?= old('code_client', $code_client) ?>"
                                required>
                            <?= error('code_client') ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <label>
                                    <input type="radio" name="type_client" value="particulier" checked onchange="toggleClientType()"> Particulier
                                </label>
                                <label>
                                    <input type="radio" name="type_client" value="entreprise" onchange="toggleClientType()"> Entreprise
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <label>
                        <input type="checkbox" name="actif" value="1" checked> Client actif
                    </label>
                </div>
            </div>
