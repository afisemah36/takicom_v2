...
<div class="page-header">
    ...
    <div class="page-actions">
        <a href="<?= url('/factures/create') ?>" class="btn btn-primary">
...
<div class="card">
    <div class="card-header">
        <div class="search-box">
            <form method="GET" action="<?= url('/factures') ?>" class="search-form">
                        ...
                        <?php foreach ($factures as $facture): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="<?= url('/factures/' . $facture->id_facture_client) ?>" class="btn btn-sm btn-info" title="Voir">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if ($facture->statut !== 'payée'): ?>
                                            <a href="<?= url('/factures/' . $facture->id_facture_client . '/edit') ?>" class="btn btn-sm btn-warning" title="Modifier">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button onclick="deleteFacture(<?= $facture->id_facture_client ?>)" class="btn btn-sm btn-danger" title="Supprimer">
                                                <i class="fas fa-trash"></i>
                                            </button>
                                        <?php endif; ?>
                                        <a href="<?= url('/factures/' . $facture->id_facture_client . '/pdf') ?>" class="btn btn-sm btn-secondary" title="PDF" target="_blank">
...
<script>
    function deleteFacture(id) {
        if (confirm('Êtes-vous sûr de vouloir supprimer cette facture ?')) {
            ...
            form.method = 'POST';
            form.action = '<?= url('/factures') ?>/' + id + '/delete';
